    ...
    return (
      ...
      >
        ...
        <div className="flex gap-2.5">
          ...
          `}
          >
            <span className="absolute  top-0.5 left-0 w-full h-5/6 bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-sm" />
      ...
      <div className="flex justify-center sm:justify-start items-center gap-2">
        ...
        >
          <span className="font-thin md:text-sm text-base">
            Criar <span className="hidden sm:inline">conta</span>
          </span>
